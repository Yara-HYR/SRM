...
FORMAT_CONFIG = {
    'rl': {
        ...
        'eval': [('step', 'S', 'int'), ('episode_reward', 'ER', 'float'), ('episode_reward_color_easy', 'ERTEST', 'float'),('episode_reward_color_hard', 'ERTEST', 'float'),('episode_reward_video_easy', 'ERTEST', 'float'),('episode_reward_video_hard', 'ERTEST', 'float')]
    }
}
